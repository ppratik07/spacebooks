...
export const MyBookings = () => {
    ...
    return (
        <div>
            {hasBooking ? (
                <div>
                    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-400 dark:border-gray-400">
                        ...
                        <div className="flex flex-col items-center pb-10">
                            ...
                            <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">{bookingData.name}</h5>
                            {/* <span className="text-sm text-gray-500 dark:text-gray-400">V</span> */}
                            <div className="flex mt-4 ml-2 md:mt-6">
                                <div>
                                    <p>Date: {bookingData.date}<br /></p>
                                </div>
                                <div>
